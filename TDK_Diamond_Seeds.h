...
#include "utility/AudioZero_TDSs.h"
...
#define THERMISTORPIN 19 ///<thermistor pin
#define AUDIOPIN 14///< audio pin
...
class TDK_DiamondSeeds {
  ...
  public:
    ...
    Adafruit_NeoPixel strip; ///< the neopixel strip object
    void clearPixels(void) { strip.clear(); strip.show(); }//turn off all neopixels on the board
