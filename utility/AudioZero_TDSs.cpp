...
void AudioZeroClass_TDSs::begin(uint32_t sampleRate) {
...
void AudioZeroClass_TDSs::play(File myFile) {
 ...
 */
void AudioZeroClass_TDSs::dacConfigure(void){
 ...
 */
 void AudioZeroClass_TDSs::tcConfigure(uint32_t sampleRate)
{
...
bool AudioZeroClass_TDSs::tcIsSyncing()
{
  return TC3->COUNT16.STATUS.reg & TC_STATUS_SYNCBUSY;
}

void AudioZeroClass_TDSs::tcStartCounter()
{
  // Enable TC
...
void AudioZeroClass_TDSs::tcReset()
{
  // Reset TCx
...
void AudioZeroClass_TDSs::tcDisable()
{
  // Disable TC3
  TC3->COUNT16.CTRLA.reg &= ~TC_CTRLA_ENABLE;
  while (tcIsSyncing());
...
AudioZeroClass_TDSs AudioZero_TDSs;
